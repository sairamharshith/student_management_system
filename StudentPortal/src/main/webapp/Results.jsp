...
<style>
    ...
    body{
       background-image: url('https://images.pexels.com/photos/6684373/pexels-photo-6684373.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'); 
    ...
    <div class="container p-3">
        <center>
            <form action="Results.jsp" method="post" class="mt-5">
            	<h4 class="mt-3 mb-5 p-2 text text-danger">Check Your Result by entering the Roll Number</h4>
